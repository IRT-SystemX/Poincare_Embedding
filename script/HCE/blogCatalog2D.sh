CUDA_VISIBLE_DEVICES=0 python3.7 launcher_tools/experiment_poincare_alternate_moving_context_size.py --loss-aggregation sum --distance-coef 1.0 --dataset blogCatalog  --n-gaussian 39 --walk-lenght 60 --precompute-rw 10  --epoch 1 --epoch-embedding 1  --epoch-embedding-init 10 --beta 1.  --alpha .5 --gamma 10. --lr  .01 --negative-sampling 5  --context-size 10  --cuda --embedding-optimizer exphsgd  --em-iter 5 --id 12102019blogCatalog-2D-1  --size 2 --seed 246 --batch-size 256

python3.7 launcher_tools/evaluation_unsupervised_poincare.py --file /local/gerald/POINCARE-EM/12102019blogCatalog-2D-1
python3.7 launcher_tools/evaluation_classifier_poincare.py --init --file /local/gerald/POINCARE-EM/12102019blogCatalog-2D-1
python3.7 launcher_tools/evaluation_supervised_poincare.py --file /local/gerald/POINCARE-EM/12102019blogCatalog-2D-1

CUDA_VISIBLE_DEVICES=0 python3.7 launcher_tools/experiment_poincare_alternate_moving_context_size.py --loss-aggregation sum --distance-coef 1.0 --dataset blogCatalog  --n-gaussian 39 --walk-lenght 60 --precompute-rw 10  --epoch 5 --epoch-embedding 1  --epoch-embedding-init 10 --beta 1.  --alpha .5 --gamma 10. --lr  .01 --negative-sampling 5  --context-size 10  --cuda --embedding-optimizer exphsgd  --em-iter 5 --id 12102019blogCatalog-2D-2  --size 2 --seed 247 --batch-size 256
...
CUDA_VISIBLE_DEVICES=0 python3.7 launcher_tools/experiment_poincare_alternate_moving_context_size.py --loss-aggregation sum --distance-coef 1.0 --dataset blogCatalog  --n-gaussian 39 --walk-lenght 60 --precompute-rw 10  --epoch 5 --epoch-embedding 1  --epoch-embedding-init 10 --beta 1.  --alpha .5 --gamma 10. --lr  .01 --negative-sampling 5  --context-size 10  --cuda --embedding-optimizer exphsgd  --em-iter 5 --id 12102019blogCatalog-2D-4  --size 2 --seed 249 --batch-size 256
