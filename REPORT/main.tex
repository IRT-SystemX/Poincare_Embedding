...
\begin{document}
    ...
    \begin{table}
        \begin{tabular}{|cccccccc|c|}
            \hline
            lr & alpha & beta & dim & Method Optimization& epoch & embed iter &em iter & Performances \\
            \hline
            10 & .1 & 1.& 2 & exphsgd & 1 & 600 & 1 & $69.56 \pm 7.38$ \\
            10 & .1 & 1.& 3 & exphsgd & 1 & 600 & 1 & $79.13 \pm 1.23$ \\
            \hline
        \end{tabular}
    \label{DBLP-RES}
    \caption{FOOTBALL Performances obtained  with kmeans (2xp each)}
\end{table}
