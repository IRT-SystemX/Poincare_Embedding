...
\begin{document}
    ...
    \begin{figure}[!ht]
        ...
        \begin{subfigure}[b]{0.48\linewidth}
            \centering
            \includegraphics[scale=0.35]{media/fig0.pdf}
            \caption{\label{fig:n1}:Kmeans only}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\linewidth}
             \centering
            \includegraphics[scale=0.35]{media/fig1.pdf}
            \caption{\label{fig:n2}: $1^{st}$ EM iteration}
    
        \end{subfigure}
        \begin{subfigure}[b]{0.48\linewidth}
            \centering
            \includegraphics[scale=0.35]{media/fig2.pdf}
            \caption{\label{fig:n1}:$2^{nd}$ EM iteration}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\linewidth}
             \centering
            \includegraphics[scale=0.35]{media/fig50.pdf}
    ...
    \begin{figure}[!ht]
        ...
        \begin{subfigure}[b]{0.48\linewidth}
            \centering
            \includegraphics[scale=0.35]{media/_mixture_weights.pdf}
            \caption{\label{fig:n1}:Mixture weights}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\linewidth}
             \centering
            \includegraphics[scale=0.35]{media/_variances.pdf}
