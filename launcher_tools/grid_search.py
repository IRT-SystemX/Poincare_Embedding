...
parser = argparse.ArgumentParser(description='Experiments launcher \
                                 for Deep Sparse Dictionary learning')
...
parser.add_argument('--database-name', metavar='d', dest="database", type=str, default="GERALD",
                    help="if use mongo the database where will be registered waiting xps")
parser.add_argument('--server-name', metavar='s', dest="server_name", type=str, default="drunk",
