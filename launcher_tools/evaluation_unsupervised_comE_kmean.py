...
import em_tools.euclidean_kmeans as ekm
...
for i in tqdm.trange(args.n):
    total_accuracy = evaluation.unsupervised_evaluation(representations, D.Y, n_gaussian, ekm.sklearnKMeans, verbose=False)
...
log_in.append({"evaluation_unsupervised_come_perf": {"unsupervised_performances":R.tolist()}})
...
log_in.append({"evaluation_unsupervised_come_cond": {"unsupervised_conductence":C.tolist()}})
