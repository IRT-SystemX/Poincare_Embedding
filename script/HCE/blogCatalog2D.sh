CUDA_VISIBLE_DEVICES=0 python3.7 launcher_tools/experiment_poincare_alternate_moving_context_size.py --loss-aggregation sum --distance-coef 1.0 --dataset blogCatalog  --n-gaussian 39 --walk-lenght 60 --precompute-rw 10  --epoch 5 --epoch-embedding 1  --epoch-embedding-init 10 --beta 1.  --alpha 5. --gamma 1. --lr  .001 --negative-sampling 5  --context-size 10  --cuda --embedding-optimizer exphsgd  --em-iter 5 --id 12102019blogCatalog-2D-1  --size 2 --seed 246 --batch-size 256
